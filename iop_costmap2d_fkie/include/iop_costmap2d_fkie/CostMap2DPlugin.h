...
#ifndef COSTMAP2DPLUGIN_H
#define COSTMAP2DPLUGIN_H

#include "urn_jaus_jss_iop_CostMap2D/CostMap2DService.h"
...
class DllExport CostMap2DPlugin : public PluginInterface
{
public:
	CostMap2DPlugin();
...
protected:
	urn_jaus_jss_iop_CostMap2D::CostMap2DService *p_my_service;
