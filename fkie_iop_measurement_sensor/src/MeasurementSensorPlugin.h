...
#ifndef MEASUREMENTSENSORPLUGIN_H
#define MEASUREMENTSENSORPLUGIN_H

#include "urn_jaus_jss_iop_MeasurementSensor/MeasurementSensorService.h"
...
class DllExport MeasurementSensorPlugin : public PluginInterface
{
public:
	MeasurementSensorPlugin();

	JTS::Service* get_service();
	void create_service(JTS::JausRouter* jaus_router);

protected:
	urn_jaus_jss_iop_MeasurementSensor::MeasurementSensorService *p_my_service;
