...
#ifndef PATHREPORTERPLUGIN_H
#define PATHREPORTERPLUGIN_H

#include "urn_jaus_jss_iop_PathReporter/PathReporterService.h"
...
class DllExport PathReporterPlugin : public PluginInterface
{
public:
	PathReporterPlugin();
...
protected:
	urn_jaus_jss_iop_PathReporter::PathReporterService *p_my_service;
